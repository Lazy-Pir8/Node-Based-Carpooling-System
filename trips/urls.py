...
urlpatterns = [
    ...
    path(
        "request_offers/<int:request_id>/", views.request_offers, name="request_offers"
    ),
    ...
    path(
        "create_offer/<int:request_id>/<int:trip_id>/",
        views.create_offer,
        name="create_offer",
    ),
    path(
        "update_trip_node/<int:trip_id>/",
        views.UpdateTripNodeView.as_view(),
        name="update_trip_node",
    ),
]
