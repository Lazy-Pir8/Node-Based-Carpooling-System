...
class Trip(models.Model):
    ...
    passengers = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="booked_trips", blank=True
    )
...
class TripNode(models.Model):
    trip = models.ForeignKey(
        "Trip", related_name="trip_nodes", on_delete=models.CASCADE
    )
...
class CarpoolRequest(models.Model):
    ...
    pickup_node = models.ForeignKey(
        "network.Node", related_name="pickup_requests", on_delete=models.CASCADE
    )
    destination_node = models.ForeignKey(
        "network.Node", related_name="destination_requests", on_delete=models.CASCADE
    )
...
class DriverOffer(models.Model):
    request = models.ForeignKey(
        CarpoolRequest, related_name="offers", on_delete=models.CASCADE
    )
